              ...
              : (u.selection.select(h),
                ...
                ((f = h).onload = function () {
                  p.width ||
                    p.height ||
                    !C(g) ||
                    g.dom.setAttribs(f, { width: String(f.clientWidth), height: String(f.clientHeight) }),
                    y();
                }),
                (f.onerror = y)))
          : ((a = t),
  ...
  function de(e, t, n, r) {
    ...
    (U = t),
      ...
      void 0 !== (S = w.src.meta) &&
        ...
        v.hasDimensions &&
          (T(D.width) && (A.dimensions.width = D.width), T(D.height) && (A.dimensions.height = D.height)),
        T(D.class) &&
