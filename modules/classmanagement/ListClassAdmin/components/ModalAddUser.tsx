...
export default function ModalAddUser(props: any) {
  const { modalUpdateRole, setModalUpdateRole } = props;
  ...
  const onSubmit = async (rawdata: any) => {
    const res = await LearnClassesService.createClassSettingUser({
      userId: userId,
