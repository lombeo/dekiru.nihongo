...
export const CodeActivitySchema = yup.object({
  title: yup
    .string()
    .trim()
  ...
  functionName: (yup.string() as any)
    .trim()
    .required("Function name is required")
    .functionName("Function name invalid!"),
  ...
  listInputs: (yup.array() as any).of(
    yup.object().shape({
      name: (yup.string() as any).trim().required("This field is required"),
    })
  ),
