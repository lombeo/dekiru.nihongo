...
import { QuestionFormSchema } from "validations/cms/question.schemal";
...
export const MultipleChoiceForm = (props: any) => {
  const { data, questionBankId, type, onSave, onDiscard, isAllowToEdit, saveDisabled = false, isView = false } = props;
