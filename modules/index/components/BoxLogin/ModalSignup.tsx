  ...
  return (
    ...
    >
      <div className="bg-white rounded-[32px] px-5 py-6 gmd:p-12 flex flex-col items-start gap-8 w-full relative z-[2]">
        <span className="text-xl leading-[30px] text-[#111928] font-semibold">Bắt đầu ngay</span>
        ...
        <div className="w-full flex flex-col gap-[10px]">
          <div className="w-full flex flex-row items-center gap-2">
            <span className="text-xs leading-5 font-normal text-[#637381]">Hoặc tiếp tục với</span>
