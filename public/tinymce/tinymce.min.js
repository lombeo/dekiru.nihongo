...
!(function () {
    ...
    Nt = {
      fromHtml: function (e, t) {
        ...
        if (((n.innerHTML = e), !n.hasChildNodes() || 1 < n.childNodes.length))
          throw (
            (console.error("HTML does not have a single root node", e), new Error("HTML must have a single root node"))
          );
      ...
      Y(a, function (e, r) {
        ...
        u.push(o),
          (n[o] = function () {
            ...
            if (t !== i.length)
              throw new Error(
                "Wrong number of arguments to case " + o + ". Expected " + i.length + " (" + i + "), got " + t
              );
            return {
              fold: function () {
                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    ...
    return (
      (jr(e) &&
        !1 ===
          ...
          jn((i = e)) &&
            qr(i.data) &&
            !1 === ((n = i), (r = Nt.fromDom(a)), hr(Nt.fromDom(n), "pre,code", A(je, r)).isSome()))) ||
      (zn((o = e)) &&
        "A" === o.nodeName &&
        !o.hasAttribute("href") &&
  ...
  function to(i) {
    function e(e, t, n) {
      ...
      return (
        r
          ...
          : (r = Jo[e]) || ((r = Zo(t, " ", Zo(t.toUpperCase(), " "))), (r = ti(r, n)), (Jo[e] = r)),
        r
      );
    }
    var t,
    ...
    function g(e, t, n) {
      ...
      for (var a = Zr(e), u = a.length; u--; )
        (i = { attributes: r((o = Zr([s, t].join(" ")))), attributesOrder: o, children: r(n, Qo) }), (c[a[u]] = i);
    }
    function p(e, t) {
  ...
  var co = Tr(["h1", "h2", "h3", "h4", "h5", "h6"]),
      ...
      decode: function (e) {
        return e.replace($o, function (e, t) {
          return t
            ...
            : Xo[e] ||
                Yo[e] ||
                ((n = e), ((r = Nt.fromTag("div").dom).innerHTML = n), r.textContent || r.innerText || n);
          var n, r;
        });
      },
    },
    ...
    ai =
                ...
                : (f.hasMouseEnterLeave ||
                    ((s = f.mouseEnterLeave[u]) &&
                      (c = function (e) {
                        ...
                        n ||
                          (((e = so(e || d.event)).type = "mouseout" === e.type ? "mouseleave" : "mouseenter"),
                          (e.target = t),
      ...
      (ui.prototype.clean = function (e) {
        ...
        if (!e || 3 === e.nodeType || 8 === e.nodeType) return this;
        if (
          (e[this.expando] && this.unbind(e), (e = e.getElementsByTagName ? e : e.document) && e.getElementsByTagName)
        )
    ...
    (mi = aa.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = li.preFilter; a; ) {
          ...
          (n = !1),
          (r = Xi.exec(a)) &&
            ((n = r.shift()), o.push({ value: n, type: r[0].replace(Wi, " ") }), (a = a.slice(n.length))),
          li.filter))
                ...
                if ((n = li.relative[t[s].type])) f = [ga(pa(f), n)];
                  ...
                  if ((n = li.filter[t[s].type].apply(null, t[s].matches))[ki]) {
                    ...
                    return (function e(m, g, p, h, v, t) {
                      ...
                      1 < s && pa(f),
                      1 < s &&
                        ma(t.slice(0, s - 1).concat({ value: " " === t[s - 2].type ? "*" : "" })).replace(Wi, "$1"),
                      n,
                      s < r && e(t.slice(s, r)),
                      r < i && e((t = t.slice(r))),
                      r < i && ma(t)
  ...
  (wa.fn = wa.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (n = Wa.unique(this.toArray().concat(Wa.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++)
            this[r] = n[r];
      ...
      function (o, i) {
        wa.fn[o] = function (t, e) {
          ...
          this.each(function () {
            ...
            1 < this.length &&
              ((n = Wa.unique(n)), (0 !== o.indexOf("parents") && "prevUntil" !== o) || (n = n.reverse()));
          var r = Wa(n);
          ...
          (function (e) {
            function r(e) {
              ...
              0 !== e.height &&
                ((0 < o.length &&
                  ((t = o[o.length - 1]),
                  e.left === t.left && e.top === t.top && e.bottom === t.bottom && e.right === t.right)) ||
                  o.push(e));
            }
            function t(e, t) {
              ...
              0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), Fu(n) || r(zu(is(n), !1))),
                t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), Fu(n) || r(zu(is(n), !0)));
            }
            var o = [],
              n = e.container(),
              i = e.offset();
  ...
  function qc(e, t, n) {
    return (
      !1 === t.hasChildNodes() &&
      Hc(e, t) &&
      ((o = n), (i = (r = t).ownerDocument.createTextNode(Co)), r.appendChild(i), o.setStart(i, 0), o.setEnd(i, 0), 1)
    );
    var r, o, i;
  }
  function $c(e, t, n, r) {
  ...
  function Xc(t, e) {
    !(function (e, t) {
      ...
      if (t) {
        if (jc(t))
          return (d = t), (m = (f = g).createRng()), $c(f, !0, d, m) && $c(f, !1, d, m) ? ve.some(m) : ve.none();
        if (X(t.start))
          return ve.some(
            ((s = t),
            (c = (u = g).createRng()),
  ...
  function Sl(e, t, n, r) {
    ...
    return (
      ...
      (ll(c) || fl(c)) &&
        ...
        ll(c) && (s.isBlock(o) || (o = xl(s, n, o, i, !0)), s.isBlock(a) || (a = xl(s, n, a, u, !1)))),
  ...
  function Rl(o, e) {
    return dn(
      ((r = e.startContainer),
      (i = e.startOffset),
      jn(r) ? (0 === i ? ve.some(Nt.fromDom(r)) : ve.none()) : ve.from(r.childNodes[i]).map(Nt.fromDom)),
      ((t = e.endContainer),
      (n = e.endOffset),
      jn(t)
        ? n === t.data.length
  ...
  var zl,
    ...
    Yl = function (e, t, n) {
      ...
      if (ql(c)) {
        ...
        if (0 < e && l < c.childNodes.length && ((f = Oc(c, l)), Kl(f)))
          return Wl(f)
            ? ((a = n),
              (s = (u = f).nextSibling) && Kl(s) ? (ql(s) ? as(s, 0) : as.before(s)) : Yl(ic.Forwards, as.after(u), a))
            : !Ul(f) && (o = Ks(f, e, Xl, f))
            ? ql(o)
              ? as(o, 0)
              : as.before(o)
    ...
    rf = function (e, t, n) {
      return 2 === t
        ...
        : 3 === t
        ? ((o = (r = e).getRng()),
          { start: fs(r.dom.getRoot(), as.fromRangeStart(o)), end: fs(r.dom.getRoot(), as.fromRangeEnd(o)) })
        : t
        ? { rng: e.getRng() }
        : Cs(e, !1);
      var r, o;
  ...
  function Cf(r, l) {
    ...
    function i(e) {
      ...
      return (
        ...
        e !== l.getBody() &&
        (T.hasClass(e, "mce-preview-object") ? ze(Nt.fromDom(e.firstElementChild), t) : ze(Nt.fromDom(e), t))
      );
    }
    function a(e, t, n) {
      V(n) &&
          ...
          (xt.browser.isIE() || xt.browser.isEdge()) &&
            (l.on("mousedown click", function (e) {
              ...
              N ||
                !/^(TABLE|IMG|HR)$/.test(n) ||
                u(t) ||
                (2 !== e.button && l.selection.select(t, "TABLE" === n), "mousedown" === e.type && l.nodeChanged());
            }),
            T.bind(
              M,
              "mscontrolselect",
  ...
  function wf(t, n, r) {
    ...
    if (s.caretPositionFromPoint)
      (e = s.caretPositionFromPoint(t, n)) && ((o = r.createRange()).setStart(e.offsetNode, e.offset), o.collapse(!0));
    ...
    return (
      t === r && jn(t)
        ? 0 < n &&
          ...
          n < o ? ((t = r = Df(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
    ...
    var t,
      ...
      r = ad(e)
        ? ((t = Nt.fromDom(e.getBody())),
          ((n = Tt(t).dom.getSelection()) && 0 !== n.rangeCount ? ve.from(n.getRangeAt(0)) : ve.none())
            .map(ud)
            .filter(id(t)))
        : ve.none();
  ...
  var jd = Et.each,
    ...
    Kd =
      ...
      (Xd.isDomSafe = function (e, t, n) {
        ...
        return !(
          ...
          !(r = n).allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? (V((a = r.allow_svg_data_urls)) ? !a : !V(i) || !D(Wd, i)) && /^data:image\/svg\+xml/i.test(o)
              : /^data:/i.test(o)))
        );
      }),
      (Xd.getDocumentBaseUrl = function (e) {
        var t =
          0 !== e.protocol.indexOf("http") && "file:" !== e.protocol ? e.href : e.protocol + "//" + e.host + e.pathname;
        return (
          /^[^:]+:\/\/\/?[^\/]+\//.test(t) &&
      ...
      (Xd.prototype.toAbsPath = function (e, t) {
        ...
        return (
          0 !==
            (r = (n = u.length - o) <= 0 ? q(i).join("/") : u.slice(0, n).join("/") + "/" + q(i).join("/")).indexOf(
              "/"
            ) && (r = "/" + r),
              ...
              if (b)
                for (r = b.length; r--; )
                  (a = (m = b[r]).name) in c.map ||
                    ("{$uid}" === (C = m.value) && (C = "mce_" + E++), (c.map[a] = C), c.push({ name: a, value: C }));
              if (v) {
      ...
      parse: function (e, t) {
        void 0 === t && (t = "html"),
          n(
            (function (e) {
              for (
                var t, n = /data:[^;]+;base64,([a-z0-9\+\/=\s]+)/gi, r = [], o = {}, i = yu("img"), a = 0, u = 0;
                (t = n.exec(e));
  ...
  function tm(e) {
    ...
    return {
      start: function (e, t, n) {
        var r, o, i, a;
        if (
          (s && c[e] && 0 < u.length && 0 < (a = u[u.length - 1]).length && "\n" !== a && u.push("\n"),
          u.push("<", e),
          t)
        )
              ...
              if (f && o && 1 < o.length) {
                ...
                if (a) {
                  ...
                  for (var c, l, u = 0, s = o.length; u < s; u++)
                    (c = o[u].name) in i.map || ((l = o.map[c]), (i.map[c] = l), i.push({ name: c, value: l }));
                  o = i;
                }
              }
  ...
  function Om(e, t) {
    return (
      Dm(e, t) || Tm(e, ((r = (n = t).container()), (o = n.offset()), jn(r) && o < r.data.length ? as(r, o + 1) : n))
    );
    var n, r, o;
  }
  function Bm(e, t) {
  ...
  function yg(e) {
    return 0 < e.length &&
      (!(r = e[e.length - 1]).firstChild ||
        ((t = r) && t.firstChild && t.firstChild === t.lastChild && ((n = t.firstChild).data === yo || Wn(n))))
      ? e.slice(0, -1)
      : e;
    var t, n, r;
  }
          ...
          if (e) {
            ...
            jn(s)
              ? (u.setStart(s, s.nodeValue.length),
                xt.ie || ((a = e.nextSibling), jn(a) && (s.appendData(a.data), a.parentNode.removeChild(a))))
                      ...
                      Y(e, function (e) {
                        ...
                        Y(n, function (e) {
                          "string" == typeof t.attr(e.name) &&
                            (i[e.name] ? i[e.name].nodes.push(t) : (i[e.name] = { filter: e, nodes: [t] }));
                        });
                    }),
                  o))
                    Ne(o, t) && a.push(o[t]);
  ...
  function Og(e, t, n, r, o, i) {
    ...
    if (a)
      if (b(a.length)) {
        ...
        for (var f = 0; f < a.length; f++) if ("attributes" === r ? e.getAttrib(t, a[f]) : al(e, t, a[f])) return 1;
    return 1;
  }
      ...
      ? ((l = e),
        ...
        ll(d) &&
          (v
            ...
            : h.isBlock(f) &&
              !h.isBlock(p) &&
              (Bp(h, f, !1) || Bp(h, f.firstChild, !0, !0) || f.insertBefore(h.create("br"), f.firstChild),
  ...
  function Kp(e, t) {
    for (var n = e.rows, r = 0; r < n.length; r++)
      for (var o = n[r].cells, i = 0; i < o.length; i++) if (je(o[i], t)) return ve.some({ x: i, y: r });
    return ve.none();
  }
      ...
      undoManager: {
        ...
        undo: function (e, t, n) {
          return (
            ...
            0 < a.get() &&
              (a.set(a.get() - 1), ih(r, (u = o.data[a.get()]), !0), r.setDirty(!0), r.fire("Undo", { level: u })),
            u
          );
          var r, o, i, a, u;
        },
        redo: function (e, t) {
          return (
            ...
            (o = t),
            (r = e).get() < o.length - 1 &&
              (r.set(r.get() + 1), ih(n, (i = o[r.get()]), !1), n.setDirty(!0), n.fire("Redo", { level: i })),
            i
          );
          var n, r, o, i;
        },
        ...
        getContent: function (e, t) {
          return (function (e, t, n) {
            ...
            return "tree" === i.format
              ? g
              : ((i.content = e.selection.isCollapsed() ? "" : g), e.fire("GetContent", i), i.content);
          })(c, e, t);
        },
      },
      raw: {
      ...
      function g(e, t) {
        ...
        return (
          Ah(e, function (e) {
            return (
              !!fl(e) &&
              ((V(e.collapsed) && e.collapsed !== a) || !u.is(t, e.selector) || zc(t) ? void 0 : (k(t, e), !(n = !0)))
            );
          }),
          n
        );
            ...
            (!(1 < w.length) && x.isBlock(e)) || 0 !== y
              ? (dl(A) || (ll(A) && A.wrapper)) &&
                ...
                (i = A).styles &&
                  ...
                  wh(a, kp(x, "fontSize"), _p(x, "backgroundColor", rl(i.styles.backgroundColor, N))),
                (m = x),
                (p = e),
    ...
    var l,
      ...
      p = function () {
        ...
        try {
          (t = c()) &&
            !rn(t.anchorNode) &&
            ((n = 0 < t.rangeCount ? t.getRangeAt(0) : (t.createRange ? t : o).createRange()), (n = wd(s, [n])[0]));
        } catch (e) {}
        return (
        ...
        if ((r = e) && (Bh(r) || (Ph(r.startContainer) && Ph(r.endContainer)))) {
          ...
          if (o) {
            ...
            if (((e = s.fire("SetSelectionRange", { range: e, forward: t }).range), i)) {
              ...
              !1 === t &&
                i.extend &&
                (i.collapse(e.endContainer, e.endOffset), i.extend(e.startContainer, e.startOffset)),
            ...
            ve
              ...
              .map(function (e) {
                var t = r.nodeIndex(e),
                  n = r.createRng();
                return (
                  n.setStart(e.parentNode, t), n.setEnd(e.parentNode, t + 1), o && (Dl(r, n, e, !0), Dl(r, n, e, !1)), n
                );
              })
              .each(h),
            e
                      ...
                      if (o[c.name] && "li" === c.parent.name) {
                        ...
                        if (l && 1 < m.length)
                          if (A.isValidChild(l.name, c.name)) {
                            ...
                            Vh(A, n, r, s) ? l.insert(c, m[0], !0) : (l.insert(s, m[0], !0), l.insert(c, s)),
                              (l = m[0]),
          ...
          b &&
            ...
            (function () {
              ...
              if (A.isValidChild(k.name, b.toLowerCase())) {
                for (; t; ) {
                  var r = t.next;
                  3 === t.type || (1 === t.type && "p" !== t.name && !m[t.name] && !t.attr("data-mce-type"))
                    ? (n || ((n = d(b, 1)).attr(_.forced_root_block_attrs), k.insert(n, t)), n.append(t))
                    : (e(n), (n = null)),
                    (t = r);
                }
                e(n);
        ...
        serialize: function (e, t) {
          ...
          return "tree" === T.format
            ...
            : ((N = I),
              ...
              k.no_events || !N ? D : ((A = N), (R = _e(_e({}, k), { content: D })), A.fire("PostProcess", R).content));
        },
  ...
  function av(e, t, n) {
    var r,
      ...
      f =
        ...
        { x: i - (r ? u.left + o.dom.clientLeft + Tv(o) : 0), y: a - (r ? u.top + o.dom.clientTop + Dv(o) : 0) }),
      d = f.x,
      m = f.y,
      g = Av((s = l)),
      p = Rv(s);
      ...
      g.on("NodeChange", function (e) {
        ...
        !Ps(g) ||
          ...
          (l = g).selection.isCollapsed() &&
            ...
            as.isTextPosition(d) && !1 === (Fr((m = d)) || Ur(m)) && (t0(l, Hs(f.get(), d)), f.set(null))),
          (n = h),
          (r = g),
          (o = p),
          (t = e.parents),
  ...
  function L0(h, v) {
    ...
    return pr(Nt.fromDom(e.container()), lo, t)
      ...
      .exists(function () {
        if (
          ((d = b), (m = y), v ? ((p = d.dom), My(p, m).breakAt.isNone()) : ((g = d.dom), Iy(g, m).breakAt.isNone()))
        ) {
          var e =
            ((t = b),
            (r = x),
      ...
      (((p && !h) || (!p && h)) &&
        (m = (function (e, t, n, r) {
          ...
          if (!m || !oC(f, m)) {
            if (
              ((s = (
                (m = m || d) === e.getBody() || ((c = m) && /^(TD|TH|CAPTION)$/.test(c.nodeName)) ? m : m.parentNode
  ...
  function a1(e) {
    ...
    function n(u) {
      i.on(function (e) {
        var t, n, r, o, i, a;
        e.dragging &&
          ((o = 3 === (a = (r = s).selection.getSel().getRangeAt(0).startContainer).nodeType ? a.parentNode : a) ===
            (i = e.element) ||
            r.dom.isChildOf(o, i) ||
            D1(o) ||
        ...
        if (f(c))
          return (function (e) {
            ...
            var r = (function (e, t, n) {
                ...
                0 === o.length &&
                  (o = r('<div data-mce-bogus="all" class="mce-offscreen-selection"></div>').attr("id", w)).appendTo(
                    l.getBody()
                  );
                var i = y.createRng();
                t === n && xt.ie
              ...
              u(e) ||
                ((t =
                  e.dataTransfer && (o = e.dataTransfer.getData(N)) && 0 <= o.indexOf(E)
                    ? ((o = o.substr(E.length).split(",")), { id: unescape(o[0]), html: unescape(o[1]) })
                    : null) &&
                  t.id !== a.id &&
                  (e.preventDefault(),
  ...
  function w1(e) {
    ...
    return (
      ...
      e.inline
        ...
        : ((p = b1((m = e), (g = h))),
          g.editorContainer &&
            ((I1.get(g.editorContainer).style.display = m.orgDisplay), (m.hidden = I1.isHidden(g.editorContainer))),
    ...
    F1 = function (t, n, r) {
      ...
      if (
        ...
        try {
          ...
          (i = r),
            (a = e),
            vf((o = t), "PluginLoadError", { message: (u = uu.translate(["Failed to initialize plugin: {0}", i])) }),
            ay(u, a),
            Iv(o, u);
        }
    },
        ...
        "click" !== (o = n).type ||
          ...
          br(i, "a", function (e) {
            ...
            .each(function (e) {
              ...
              o.preventDefault(),
                /^#/.test(e)
                  ? (t = r.dom.select(e + ',[name="' + (Ge((n = e), "#") ? n.substring("#".length) : n) + '"]'))
        ...
        "focus" !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized && (n.dom.unbind(ix(n, e), e, n.delegates[e]), delete n.delegates[e])));
      },
  ...
  var xx = Ja.DOM,
    ...
    kx =
            ...
            ? t.getElement() &&
              ...
              (i = t.getElement().form || U1.getParent(e, "form")) &&
                ...
                t.getParam("hidden_input") &&
                  !Hn(t.getElement()) &&
                  (U1.insertAfter(U1.create("input", { type: "hidden", name: e }), e), (t.hasHiddenInput = !0)),
      ...
      (_x.prototype.show = function () {
        this.hidden &&
          ((this.hidden = !1),
          this.inline ? (this.getBody().contentEditable = "true") : (xx.show(this.getContainer()), xx.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      ...
      (_x.prototype.getContent = function (e) {
        return (
          (t = this), (r = (n = void 0 === (n = e) ? {} : n).format || "html"), (o = n), ph(t).editor.getContent(o, r)
        );
        var t, n, r, o;
      }),
                  ...
                  (o = Et.grep(o, function (e) {
                    ...
                    : Px(o, function (e) {
                        ...
                        r.inline && t.tagName.toLowerCase() in l
                          ? ay("Could not initialize inline editor on invalid inline target element", e)
                          : n(u(e), r, e);
                      }));
          };
        return (
