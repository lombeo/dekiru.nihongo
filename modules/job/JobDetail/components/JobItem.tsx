...
const JobItem = (props: any) => {
  ...
  return (
    <Link key={data.id} className="hover:opacity-100" href={`/job/${data.permalink}`}>
      <div className="shadow-md relative border hover:border-[#2C31CF] bg-[#FAFAFF] cursor-pointer rounded-md p-5 grid lg:grid-cols-[100px_auto_132px] gap-5">
        <Image
          className="border mx-auto bg-white border-[#e9eaec] rounded-md overflow-hidden"
        ...
        <div className="flex flex-col lg:items-end">
          ...
          <div className="mt-auto gap-3 lg:flex hidden">
            ...
            <ActionIcon
              ...
              color="indigo"
            >
              {isBookmark ? <BookmarkFilled width={20} height={20} /> : <Bookmark width={20} height={20} />}
            </ActionIcon>
          </div>
        </div>
      </div>
