import { Divider, Text } from "@edn/components";
...
const AttachmentActivity = (props: AttachmentActivityProps) => {
  ...
  const onHandleComplete = async () => {
    ...
    //   };
    //   confirmAction({
    //     message: t("You have not enrolled this learn. Back to home"),
    //     onConfirm,
    //   });
    // }
  };
  ...
  return (
    <>
      <div className="px-5 pb-5">
        <ModalCompleteActivity permalink={permalink} data={data} courseId={data.courseId} />
