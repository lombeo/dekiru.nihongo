...
const GradeAssignmentModal = (props: any) => {
  const { onClose, onSuccess, activityId, selected, data: dataAssignment } = props;
  ...
  return (
    <>
      <Modal
        title={t("Grade (Max score: {{score}})", { score: dataAssignment?.activityData?.metadata?.maxScore })}
        size="xl"
        opened
        zIndex={300}
        onClose={onClose}
