  ...
  return (
    <>
      <div className="pt-10 pb-8">
        <div>
          <span className="flex justify-center">{t("No learning schedule here.")}</span>
          <span className="flex justify-center">{t("Please create a new learning schedule for this course.")}</span>
        </div>
